...
// //     // Only consider logged in if all required auth items exist
...
// //           source,
// //           destination,
// //           sort_choice: "3", // You can add UI to select this
// //           food_preference: "", // You can add UI for this
// //         }),
// //       });
...
// //       navigate('/restaurants', { state: { restaurants: data.restaurants } });
// //     } catch (error) {
// //       toast({
// //         title: "Search Failed",
...
//     const name = localStorage.getItem('userName');
//     const loginStatus = localStorage.getItem('isLoggedIn');
//     return token && name && loginStatus === 'true'; // All must be present
//   };
...
//     // Handle login state from redirect
//     if (location.state?.isLoggedIn) {
//       setIsLoggedIn(true);
//       const newUserName = location.state.userName || 'User';
//       setUserName(newUserName);
//       localStorage.setItem('isLoggedIn', 'true');
//       localStorage.setItem('userName', newUserName);
//       // Token should already be set by login page, but verify
...
//           source,
//           destination,
//           sort_choice: "3", // Default sort, can be made configurable
//           food_preference: "", // Default empty, can be made configurable
//         }),
//       });
